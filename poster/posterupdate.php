...
$id=$_REQUEST['id'];
$q=mysqli_query($connect,"select * from poster where id='$id'");
...
if(isset($update))
{
   mysqli_query($connect,"update poster set sno='$sno',Name='$Name',Contact='$Contact',Size='$Size',date='$date',Rate='$Rate',totalsqr='$totalsqr',subtotal='$subtotal',paid='$paid',pending='$pending',updateddate='" . $_REQUEST['tdate'] . "' WHERE id=$id");
		
	
	echo "Records updated";
	
	} echo "<script type='text/javascript'>alert('updated successfully!');window.location='posterreport.php';</script>";
...
$result = mysqli_query($connect, "SELECT * FROM poster WHERE id=$id");
