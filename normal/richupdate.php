...
$id=$_REQUEST['id'];
$q=mysqli_query($connect,"select * from dailyinsert where id='$id'");
...
if(isset($update))
{
   mysqli_query($connect,"update dailyinsert set sno='$sno',Name='$Name',Contact='$Contact',Size='$Size',date='$date',Rate='$Rate',totalsqr='$totalsqr',subtotal='$subtotal',paid='$paid',pending='$pending',updateddate='" . $_REQUEST['tdate'] . "' WHERE id=$id");
		
	
	echo "Records updated";
	
	} 
echo "<script type='text/javascript'>alert('updated successfully!');window.location='richreport.php';</script>";
...
$result = mysqli_query($connect, "SELECT * FROM dailyinsert WHERE id=$id");
