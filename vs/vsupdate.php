...
$id=$_REQUEST['id'];
$q=mysqli_query($connect,"select * from visitingcard where id='$id'");
...
if(isset($update))
{
   mysqli_query($connect,"update visitingcard set sno='$sno',Name='$Name',Contact='$Contact',Size='$Size',date='$date',Rate='$Rate',paid='$paid',updateddate='" . $_REQUEST['tdate'] . "' WHERE id=$id");
		
	
	echo "Records updated";
	
	} 
header("location: http://localhost/rich/vs/vsreport.php");
  }
...
$result = mysqli_query($connect, "SELECT * FROM visitingcard WHERE id=$id");
