...
$result = mysqli_query($con, "SELECT id,Name,Contact,Rate,paid,pending FROM dailyinsert where   pending>0  ORDER BY id ASC"); 
?>
<!DOCTYPE html>
<html>
<head>
...
<th>Actions</th>
    ...
    echo"<tr>";
        ...
        echo "<td><a href=\"richupdate.php?id=$res[id]\">Edit</a>  </td>";
