...
echo "Error: " . $sql1 . "<br>" . mysqli_error($con);
    ...
    if (strlen( $_REQUEST['name2'])>0 && strlen( $_REQUEST['rate2'])>0 ){
$sql2  = "INSERT INTO expenses(date,name,quantity,rate) VALUES ('" . $_REQUEST['tdate']."','" . $_REQUEST['name2']."','" . $_REQUEST['quantity2'] . "','" . $_REQUEST['rate2'] . "')";
