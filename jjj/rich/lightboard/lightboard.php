...
<div class="topnav">
  <a class="active" href="lightboard.php">Lightboard</a>
  <a href="pendingdaily.php">PendingDaily</a>
  <a href="lightreport.php">Report</a>
...
<h1  align="center"style="color:Green;">Rich Media Lightboard charge </h1>
<td >
<br/>
<br>

<form action="lightinsert.php" method="post" >
...
<td>
 ...
 <input type="text" name="sno" autocomplete=off size="10"id="sno1" required />
</td>

<td>
<input type="text" name="name" autocomplete=off size="10"id="name1" required />
</td>

<td>
<input type="text" name="Contact" autocomplete=off size="10"id="Contact1"  required />
</td>
<td>
...
<td>
<input type="text" name="Rate" autocomplete=off size="10"id="Rate1" onchange="call_totall(document.getElementById('Rate1').value);"  required />
</td>
<td>
...
<td>
<input type="text" autocomplete=off  size="10"name="pending"  readonly  id="pending1" onchange="call_pending(document.getElementById('pending1').value);" />
</td>
</tr>
...
<td>
<input type="text" autocomplete=off  size="10"name="pending1" readonly id="pending2" onchange="call_pending(document.getElementById('pending2').value);" />
</td>
</tr>
<tr>
...
<input type="text" name="sno2" autocomplete=off size="10"id="sno3" />
</td>

<td>
<input type="text" name="name2" autocomplete=off size="10"id="name3" />
</td>

<td>
<input type="text" name="Contact2" autocomplete=off size="10"id="Contact3" />
</td>
<td>
...
<td>
<input type="text" autocomplete=off  size="10"name="pending2"  readonly id="pending3" onchange="call_pending(document.getElementById('pending3').value);" />
</td>
</tr>
<tr>
...
<td>
<input type="text" autocomplete=off  size="10"name="pending3" id="pending4"   readonly  />
</td>
</tr>
