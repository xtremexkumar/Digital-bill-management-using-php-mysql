...
<h1  align="center"style="color:Green;">Rich Media ViniylFlex Entry </h1>
<td >
<br/>
<br>

<form action="viniylinsert.php" method="post" >
...
<td>
<input type="text" name="Rate" autocomplete=off size="10"id="Rate1"  required onchange="call_totall(document.getElementById('Rate1').value);" />
</td>
<td>
