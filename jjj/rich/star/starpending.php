...
$result = mysqli_query($con, "SELECT id,Name,Contact,Rate,paid,pending FROM star where   pending>0  ORDER BY id ASC"); 
?>
<!DOCTYPE html>
<html>
<head>
...
<th>Actions</th>
    ...
    echo"<tr>";
        ...
        echo "<td><a href=\"starupdate.php?id=$res[id]\">Edit</a>  </td>";
