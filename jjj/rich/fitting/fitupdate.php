...
$id=$_REQUEST['id'];
$q=mysqli_query($connect,"select * from fitting where id='$id'");
...
if(isset($update))
{
   mysqli_query($connect,"update fitting set sno='$sno',Name='$Name',Contact='$Contact',Size='$Size',date='$date',Rate='$Rate',totalsqr='$totalsqr',subtotal='$subtotal',paid='$paid',pending='$pending',updateddate='" . $_REQUEST['tdate'] . "' WHERE id=$id");
...
$result = mysqli_query($connect, "SELECT * FROM fitting WHERE id=$id");
...
<div class="topnav">
  <a class="active" href="fitting.php">NormalFlex</a>
...
<h1  align="center"style="color:Green;">Rich Media Fitting Update </h1>
<td >
<br/>
<br>
...
<td>		 
<input type="text" name="Rate" autocomplete=off onchange="sub1(document.getElementById('Rate').value);" value="<?php echo $rate;?>" size="7"id="Rate" " /> 
</td>
<td>
...
<td>
<input type="text" autocomplete=off  size="7"name="pending" value="<?php echo $pending;?>" id="pending"  readonly />
</td>
<td>
