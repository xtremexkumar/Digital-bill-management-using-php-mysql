...
$id=$_REQUEST['id'];
$q=mysqli_query($connect,"select * from gift where id='$id'");
...
if(isset($update))
{
   mysqli_query($connect,"update gift set sno='$sno',Name='$Name',Contact='$Contact',Size='$Size',date='$date',Rate='$Rate',totalsqr='$totalsqr',subtotal='$subtotal',paid='$paid',pending='$pending',updateddate='" . $_REQUEST['tdate'] . "' WHERE id=$id");
		
	
	echo "Records updated";
	
	} 
echo "<script type='text/javascript'>alert('updated successfully!');window.location='giftreport.php';</script>";
...
$result = mysqli_query($connect, "SELECT * FROM gift WHERE id=$id");
...
<div class="topnav">
  <a class="active" href="giftsales.php">gift</a>
  <a href="giftpending.php">Pending</a>
  <a href="giftreport.php">Report</a>
...
<h1  align="center"style="color:Green;">Rich Media Gift update  </h1>
<td >
<br/>
<br>
