...
$id=$_REQUEST['id'];
$q=mysqli_query($connect,"select * from foam where id='$id'");
...
if(isset($update))
{
   mysqli_query($connect,"update foam set sno='$sno',Name='$Name',Contact='$Contact',Size='$Size',date='$date',Rate='$Rate',totalsqr='$totalsqr',subtotal='$subtotal',paid='$paid',pending='$pending',updateddate='" . $_REQUEST['tdate'] . "' WHERE id=$id");
		
	
	echo "Records updated";
	
	} 
echo "<script type='text/javascript'>alert('updated successfully!');window.location='foamreport.php';</script>";
...
$result = mysqli_query($connect, "SELECT * FROM foam WHERE id=$id");
...
<div class="topnav">
  <a class="active" href="foamsales.php">Foamsheet</a>
  <a href="foampending.php">Pending</a>
  <a href="foamreport.php">Report</a>
...
<h1  align="center"style="color:Green;">Rich Media Foamsheet update  </h1>
<td >
<br/>
<br>
...
<td>		 
<input type="text" name="Rate"  onchange="sub1(document.getElementById('Rate').value);" autocomplete=off value="<?php echo $rate;?>" size="7"id="Rate" " /> 
</td>
<td>
