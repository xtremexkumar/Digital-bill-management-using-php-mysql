...
if(isset($_POST['search']))
{
	...
	$query15 = "SELECT sum(Rate)as fitting_rate,sum(paid) as fitting_paid,sum(pending) as fitting_pending FROM fitting where 1=1";
	...
	if($from_date!=null && $from_date!=''){
		...
		$query15=$query15.' and date >="'.$from_date.'"';
...
while($res = mysqli_fetch_array($result15))
{ 
...
<script>
 ...
 function rate(){
	 ...
	 var r1=0,r2=0,r3=0 ,r4=0,r5=0,r6=0,r15=0,rtotal=0;
	  var p1=0,p2,p3 ,p4,p5,p6,p15,ptotal;
	  var pe1,pe2,pe3 ,pe4,pe5,pe6,pe15,petotal;
   ...
   r15= document.getElementById('poster_rate').value.length>0?document.getElementById('poster_rate').value:0;
 
 rtotal=parseFloat(r1)+parseFloat(r2)+parseFloat(r3)+parseFloat(r4)+parseFloat(r5)+parseFloat(r6)+parseFloat(r15);
  ...
  p15= document.getElementById('poster_paid').value.length>0?document.getElementById('poster_paid').value:0;
	
 ptotal=parseFloat(p1)+parseFloat(p2)+parseFloat(p3)+parseFloat(p4)+parseFloat(p5)+parseFloat(p6)+parseFloat(p15);
...
pe6=document.getElementById('poster_pending').value.length>0?document.getElementById('poster_pending').value:0;
    ...
    petotal=parseFloat(pe1)+parseFloat(pe2)+parseFloat(pe3)+parseFloat(pe4)+parseFloat(pe5)+parseFloat(pe6);
