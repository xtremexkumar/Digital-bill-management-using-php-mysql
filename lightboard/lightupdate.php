...
$id=$_REQUEST['id'];
$q=mysqli_query($connect,"select * from lightboard where id='$id'");
...
if(isset($update))
{
   mysqli_query($connect,"update lightboard set sno='$sno',Name='$Name',Contact='$Contact',Size='$Size',date='$date',Rate='$Rate',totalsqr='$totalsqr',subtotal='$subtotal',paid='$paid',pending='$pending',updateddate='" . $_REQUEST['tdate'] . "' WHERE id=$id");
		
	
	echo "Records updated";
	
	} 
echo "<script type='text/javascript'>alert('updated successfully!');window.location='lightreport.php';</script>";
...
$result = mysqli_query($connect, "SELECT * FROM lightboard WHERE id=$id");
...
<h1  align="center"style="color:Green;">Rich Media LightBoard Update</h1>
<td >
<br/>
<br>
...
<td>
<input type="text" autocomplete=off  size="7"name="subtotal" value="<?php echo $subtotal;?>" id="SubTotal" />
</td>
<td>
...
<td>
<input type="text" autocomplete=off  size="7"name="pending" value="<?php echo $pending;?>" id="pending" />
</td>
<td>
